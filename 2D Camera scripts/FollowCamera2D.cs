...
namespace CameraControlNamespace
{
    [Flags]
    ...
    {
        [Space] [Header("Attach GameCamera and CameraRig separately")]
        public Camera gameCamera;

        public Transform target;
        [Space] [Header("Parameters")] public float dampTime = 0.15f;
...
//        Camera camera;
        ...
        void Start()
        {
//            camera = GetComponent<Camera> (); Binding camera from the inspector
            vertExtent = gameCamera.orthographicSize;
            horzExtent = vertExtent * Screen.width / Screen.height;
            deltaCenterVec = gameCamera.ViewportToWorldPoint(new Vector3(0.5f, 0.5f, 0))
            ...
            isDeadZoneHorizontal =
                ((deadZoneType & Direction.Horizontal) == Direction.Horizontal) && isFollowHorizontal;
